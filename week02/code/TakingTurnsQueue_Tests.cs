...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: the code used a list instead of a queue and used length instead of count
    ...
    // Defect(s) Found: when adding a new person in the middle, the turn order was not updated correctly
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: the code did not handle zero turns as infinite
    ...
    // Defect(s) Found: the code did not handle negative turns as infinite
